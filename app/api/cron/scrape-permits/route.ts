...
const TRADE_MAP: [string, string[], string[]][] = [
  ...
  ['Flooring & Tiling',       ['hardwood', 'laminate', 'tile', 'tiling', 'vinyl flooring', 'subfloor', 'backsplash', 'lvp', 'lvt', 'engineered wood', 'floor installation'], ['roofing', 'hvac', 'mechanical', 'plumbing', 'electrical', 'sewer']],
  ['Drywall & Taping',        ['drywall', 'taping', 'tape and mud', 'gypsum board', 'plasterboard'], ['roofing', 'hvac', 'mechanical', 'plumbing', 'electrical', 'sewer']],
  ['Kitchen & Bath Renovation', ['kitchen renovation', 'bathroom renovation', 'bath reno', 'kitchen reno', 'vanity replacement', 'cabinet installation', 'ensuite'], ['roofing', 'hvac', 'mechanical', 'plumbing', 'electrical', 'sewer']],
  ['Landscaping & Interlock',  ['interlock', 'interlocking', 'paving stone', 'retaining wall', 'grading', 'pool', 'patio stone'], ['roofing', 'hvac', 'mechanical', 'plumbing', 'electrical']],
