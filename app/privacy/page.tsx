        ...
        <div className="bg-white border border-[#e2e8f0] rounded-xl p-10 shadow-sm">
          ...
          <div className="space-y-8 text-[#374151] text-sm leading-relaxed">
            ...
            <section>
              ...
              <p>If you have questions about this Privacy Policy or your personal data, contact us at <a href="mailto:hello@jobdeck.ca" className="text-[#2563eb] hover:underline">hello@jobdeck.ca</a>.</p>
            </section>
          </div>
        </div>
      </div>
